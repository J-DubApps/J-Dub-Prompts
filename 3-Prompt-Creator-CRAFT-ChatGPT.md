...
**This is my all-time favorite prompt for using the LLM to *create prompts***.  Created by Brian Albert at [Lawton Solutions](https://lawtonsolutions.com/resources/). <br />
